...
const Favourites = () => {
  ...
  const filterByType = (movieType: string) => {
    ...
    const filtered =
      movieType === "all"
        ? fullList
        : fullList.filter((movie: WatchList) => movie.type === movieType);
      ...
      <div className="grid grid-cols-3   gap-4 items-center px-8 sm:w-[30vw] mx-auto py-6">
        <Button
          className={`border-none !py-6 px-4 rounded-[.7rem] bg-[#222]  ${
            activeType === "all" ? "bg-[#d90429]" : "bg-[#222]"
          }`}
        ...
        <Button
          className={`border-none !py-6 px-4 rounded-[.7rem] bg-[#222]  ${
            activeType === "movie" ? "bg-[#d90429]" : "bg-[#222]"
          }`}
        ...
        <Button
          className={`border-none !py-6 px-4 rounded-[.7rem] bg-[#222]  ${
            activeType === "tv" ? "bg-[#d90429]" : "bg-[#222]"
          }`}
    ...
    inset-0 bg-black/80 hidden group-hover:flex items-center justify-center
       "
          ...
          <div className="flex items-center justify-center  flex-col gap-y-3 py-6 h-[60vh] text-center">
            ...
            <p className="">
              {" "}
              Start adding your favourite movies or shows to build your
              watchlist.
            </p>
            <Link to={`/`}>
